  ...
  <Dropdown.Menu>
    ...
    <Form>
      ...
      <Button>Save</Button>
          ...
          <ButtonGroup>
         <Link to="/People"><Button variant='danger' className='mx-3' ><i className="fas fa-search me-2"style={{color:'#fff'}} ></i>Back toSearch</Button></Link>
          </ButtonGroup>
            ...
            <Container  className='table-data' fluid>
                <Table responsive className='data-table'>
                    <thead>
                        <tr>
                            <th>JD No.</th>
                            <th>CVs quality check required by Admin?</th>
                            <th>JDs upload date and time</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>N/A</td>
                            <td>Admin</td>
                            <td><span style={{backgroundColor:'green', color:'white', paddingLeft:'0.5rem', paddingRight:'0.5rem'}}>Open</span></td>
                            <td>yes</td>
                        </tr>
                        <tr>
                            <td>2</td>
                            ...
                            <td className='position'>Title<br></br> <span > <i className="fas fa-building me-2"  onClick={handleShow}></i> | <i className="fas fa-user ms-2" onClick={handleShow}></i> </span></td>
                            <td className='deatail'>Jd Name <br></br><span><a href='https://talenttrackerhr.in/'><i className="fab fa-firefox me-2"></i></a> | <a href='https://www.linkedin.com/login'><i className="fab fa-linkedin ms-2 me-2"></i></a> | </span> <i className="fas fa-eye ms-2"  onClick={handleShow1}></i></td>
                            <td className='jd-terms'><br></br><i className="fas fa-info-circle"></i></td>
                            <td>jd details</td>
                            <td>N/A</td>
                            <td>N/A</td>
                            <td>Admin</td>
                        ...
                        <tr>
                            ...
                            <td>N/A</td>
                            <td>user</td>
                            <td><span style={{backgroundColor:'red', color:'white', paddingLeft:'0.5rem', paddingRight:'0.5rem'}}>Closed</span></td>
                            <td>No</td>
                        </tr>
                    </tbody>
                </Table>
